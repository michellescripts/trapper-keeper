...
describe('DataLoader', () => {
    ...
    describe('errorRender', () => {
        it('renders the errorRender component if the data source throws an error', async () => {
            ...
            const error = {error:'A simulated test error'}
    ...
    describe('reload', () => {
        ...
        it('provides a reload callback to the error component', async () => {
            ...
            const failurePromise: Promise<string> = Promise.reject('Data loaded unsuccessfully the first time.')
            const successPromise: Promise<string> = Promise.resolve('Data loaded successfully the second time.')
